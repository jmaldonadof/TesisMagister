...
\input{00_introduccion.tex}
\input{01_teoria.tex}
%\input{02_sistema.tex}
\input{02-1_deteccion.tex}
\input{02-1_procesamiento.tex}
\input{02-2_arquitectura.tex}
\input{02-3_aplicacion.tex}
\input{03_analisis.tex}
\input{04_casos.tex}
...
\input{06_anexo.tex} % evaluación por países

\phantomsection
\addcontentsline{toc}{chapter}{Anexo B: Publicación en HCOMP 2017}
\input{07_anexo.tex} % paper HCOMP 2017

\phantomsection
\addcontentsline{toc}{chapter}{Anexo C: Menciones en la prensa}
\input{08_anexo.tex} % menciones en la prensa
%\input{09_anexo.tex} % especificación de la base de datos
